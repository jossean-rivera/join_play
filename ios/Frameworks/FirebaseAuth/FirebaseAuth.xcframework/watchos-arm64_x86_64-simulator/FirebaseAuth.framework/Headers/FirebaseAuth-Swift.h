...
SWIFT_CLASS("_TtC12FirebaseAuth12UserInfoImpl") SWIFT_AVAILABILITY(watchos,introduced=7) SWIFT_AVAILABILITY(maccatalyst,introduced=13) SWIFT_AVAILABILITY(macos,introduced=10.15) SWIFT_AVAILABILITY(tvos,introduced=13) SWIFT_AVAILABILITY(ios,introduced=13)
@interface UserInfoImpl : NSObject <FIRUserInfo>
...
SWIFT_AVAILABILITY(watchos,introduced=7) SWIFT_AVAILABILITY(maccatalyst,introduced=13) SWIFT_AVAILABILITY(macos,introduced=10.15) SWIFT_AVAILABILITY(tvos,introduced=13) SWIFT_AVAILABILITY(ios,introduced=13)
@interface UserInfoImpl (SWIFT_EXTENSION(FirebaseAuth)) <NSSecureCoding>
@end
